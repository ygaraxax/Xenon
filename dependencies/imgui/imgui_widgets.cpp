...
bool ImGui::TabButtonEx(const char* ico, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	window->DrawList->AddRectFilledMultiColor(bb.Min + ImVec2(0.000f, 0.000f), bb.Max + ImVec2(bb.Min.x - bb.Min.x - 20, bb.Min.y - bb.Min.y), ImColor(0.200f, 0.200f, it_nameanim->second, 0.100f), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(0.200f, 0.200f, it_nameanim->second, 0.100f));

	static float gradient_line = 0;

	if (IsItemClicked() || held)
		gradient_line = 0;

	if (gradient_line <= 190)
		gradient_line += 0.4f / ImGui::GetIO().Framerate * 60.f;



	float accent_color[4] = { ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).x, ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).y, ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).z, ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).w };


	if (MENU::nCurrentMainTab == 0 && label == "LegitBot")
	...
	if (MENU::nCurrentMainTab == 1 && label == "RageBot")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 2 && label == "AntiAim")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 3 && label == "Visuals")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 4 && label == "Misc")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 5 && label == "PlayerList")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 6 && label == "Skins")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 7 && label == "Lua")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

	if (MENU::nCurrentMainTab == 8 && label == "Config")
		window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));
	...
	ImGui::ShadeVertsLinearColorGradientKeepAlpha(GetWindowDrawList(), vtx_idx_1, vtx_idx_2, bb.Min + ImVec2(20, 0), bb.Max + ImVec2(bb.Min.x - bb.Min.x - 20, 20), ImColor(std::max(0.4f, it_nameanim->second * accent_color[0]), std::max(0.4f, it_nameanim->second * accent_color[1]), std::max(0.4f, it_nameanim->second * accent_color[2]), 1.00f), ImColor(0.05f, 0.05f, 0.05f, 1.00f)); // градиент
...
bool ImGui::OptButtonEx(const char* ico, const ImVec2& size_arg, bool rotation, ImGuiButtonFlags flags)
{
	...
	float accent_color[4] = { ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).x, ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).y, ImGui::GetStyleColorVec4(ImGuiCol_TitleBg).z, 1.000f };

	ImGui::PushFont(FONT::ico_button);
	...
	if (rotation)
		ImRotateEnd(1.57f * it_nameanim->second);
...
bool ImGui::TabButton(const char* icon, const char* label, float flDpiScale, bool active)
{
	ImGuiWindow* window = GetCurrentWindow();
	if (window->SkipItems)
		return false;
	...
	ImVec2 size = ImVec2(120 * flDpiScale, 15 * flDpiScale);
	...
	auto TabItem = TabItemMap->second.TabFrame = ImLerp(TabItemMap->second.TabFrame.Value, active ? ImGui::GetStyleColorVec4(ImGuiCol_TabActive) : ImVec4(ImGui::GetStyleColorVec4(ImGuiCol_TabActive).x, ImGui::GetStyleColorVec4(ImGuiCol_TabActive).y, ImGui::GetStyleColorVec4(ImGuiCol_TabActive).z, 0.f), g.IO.DeltaTime * 8.f * style.AnimationSpeed);
	...
	//window->DrawList->AddText(bb.Min + ImVec2(30 - CalcTextSize(icon).x / 2.f, bb.GetSize().y / 2.f - CalcTextSize(icon).y / 2.f), ImColor(Colors::Accent), icon);
	//PopFont();
	window->DrawList->AddText(bb.Min + ImVec2(50, bb.GetSize().y / 2.f - CalcTextSize(label).y / 2.f), ImGui::GetColorU32(ImGuiCol_Text), label);
...
bool ImGui::Keybind(const char* label, int* key, int* mode, bool label_active)
{
	...
	bool hovered_rect = ItemHoverable(rect, id, g.LastItemData.InFlags);
	...
	bool hovered_mode = ItemHoverable(mode_rect, id, g.LastItemData.InFlags);
	...
	bool hovered_key = ItemHoverable(key_rect, id, g.LastItemData.InFlags);
	...
	bool hovered = ItemHoverable(clickable, id, g.LastItemData.InFlags);
	...
	if (label_active)
		window->DrawList->AddText(rect.Min + ImVec2(1, 1), ImColor(1.f, 1.f, 1.f, 1.f), label);

	window->DrawList->AddRectFilled(key_rect.Min, key_rect.Max - ImVec2(4, 0), GetColorU32(ImGuiCol_Header), 5.f);

	PushStyleColor(ImGuiCol_Text, GetColorU32(ImVec4(9, 9, 9, 255)));
	...
	PushStyleColor(ImGuiCol_PopupBg, ImVec4(9, 9, 9, 255));
	...
	if (it_anim->second.alpha >= 0.01f)
	{
		...
		SetNextWindowSize(ImVec2(69 + 17, 100));
...
void ImGui::Keybindbox(const char* label, bool* v, int* key, int* m)
{
	...
	ImGui::SetCursorPos(GetCursorPos() - ImVec2(55, 0));
	ImGui::Keybind(label_bind.c_str(), key, m, false);

	ImGui::SetCursorPos(GetCursorPos() - ImVec2(0, GetStyle().ItemSpacing.y * 2 + 20));
...
void ImGui::ToggleButton(const char* str_id, bool* v)
{
	...
	float toggle_width = height * 1.35f;
	float toggle_height = height * 0.5f;
	float radius = height * 0.35f;

	auto deltaX = (ImGui::GetColumnWidth() - ImGui::GetScrollX() - toggle_width);


	if (ImGui::InvisibleButton(str_id, ImVec2(p.x + deltaX + toggle_width, height)))
		*v = !*v;



	const ImRect frame_bb(ImVec2(window->DC.CursorPos.x + deltaX, p.y + toggle_height / 2), ImVec2(window->DC.CursorPos.x + deltaX + toggle_width, p.y + height - toggle_height / 2));
	...
	ImU32 col_bg = *v ? GetColorU32(col) : GetColorU32(ImGuiCol_FrameBg);

	RenderFrame(frame_bb.Min, frame_bb.Max, col_bg, true, height * 0.5f);
	draw_list->AddCircleFilled(ImVec2(*v ? (window->DC.CursorPos.x + deltaX + toggle_width - radius / 2) : (window->DC.CursorPos.x + deltaX + radius / 2), p.y + toggle_height), radius, check_col, 512);


	RenderText(ImVec2(window->DC.CursorPos.x, p.y), str_id);
}
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    else if (*v)
    {
		...
		RenderFrame(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), check_col, true, style.FrameRounding);
		// gradient
		...
		//RenderCheckMark(window->DrawList, check_bb.Min + ImVec2(pad, pad), GetColorU32(ImGuiCol_Triangle), square_sz - pad * 2.0f);
    }
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
	...
	float box_width = 120.f + ImGui::CalcTextSize("1.000").x;
	auto startBox = (ImGui::GetColumnWidth() - ImGui::GetScrollX() - box_width);

    // modified by asphyxia
	const ImRect bb(window->DC.CursorPos + ImVec2(startBox, 0.0f), window->DC.CursorPos + ImVec2(startBox + box_width, h));
	...
	if (label_size.x > 0)
        // modified by asphyxia
		RenderText(ImVec2(window->DC.CursorPos.x, p.y), label);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
	...
	float slidebar_width = 120.f;
	float slidebar_height = 4.f;
	auto startSlider = (ImGui::GetColumnWidth() - ImGui::CalcTextSize("1.000").x - ImGui::GetScrollX() - slidebar_width);

	const ImRect frame_bb(ImVec2(window->DC.CursorPos.x + startSlider, window->DC.CursorPos.y + (label_size.y / 2) - (slidebar_height / 2)), window->DC.CursorPos + ImVec2(startSlider + slidebar_width, h));

	//const ImRect frame_bb(ImVec2(window->DC.CursorPos.x + deltaX, p.y + toggle_height / 2), ImVec2(window->DC.CursorPos.x + deltaX + toggle_width, p.y + height - toggle_height / 2));

	const ImRect total_bb(window->DC.CursorPos, frame_bb.Max - ImVec2(label_size.x, 0.0f));
    ...
    // Draw frame
    // modified by asphyxia
    const ImU32 frame_col = GetColorU32(g.ActiveId == id ? ImGuiCol_ControlBgActive : g.HoveredId == id ? ImGuiCol_ControlBgHovered : ImGuiCol_Border);
    RenderNavHighlight(frame_bb, id);
	//RenderFrame(frame_bb.Min, ImVec2(frame_bb.Max.x, frame_bb.Min.y + 3), GetColorU32(ImGuiCol_FrameBg), true, g.Style.FrameRounding);
	//RenderFrame(frame_bb.Min, ImVec2(frame_bb.Max.x, frame_bb.Min.y + slidebar_height), GetColorU32(ImGuiCol_FrameBg), true, g.Style.FrameRounding);
	...
	window->DrawList->AddRectFilledMultiColor(frame_bb.Min, ImVec2(grab_bb.Max.x, frame_bb.Min.y + 3), ImColor(accent_color[0] / 2, accent_color[1] / 2, accent_color[2] / 2), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0] / 2, accent_color[1] / 2, accent_color[2] / 2));


	//RenderFrame(frame_bb.Min, ImVec2(grab_bb.Max.x, frame_bb.Min.y + 3), GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab), true, style.GrabRounding); // Фрейм лилового цвета (заполненный)
	window->DrawList->AddCircleFilled(ImVec2(grab_bb.Max.x, frame_bb.Min.y + 1.5), h * 0.35f, GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab), 512); // Кружочек :)
    ...
    //window->DrawList->AddText(frame_bb.Max + ImVec2(style.FramePadding.x + GetFrameHeight(), -GetFrameHeight()), GetColorU32(ImGuiCol_Text), value_buf, value_buf_end);
	//RenderTextClipped(frame_bb.Min, frame_bb.Max, value_buf, value_buf_end, NULL, ImVec2(0.5f, 0.5f));                                                                     #Default
	//RenderTextClipped(frame_bb.Min, frame_bb.Max + ImVec2(20, 0), value_buf, value_buf_end, NULL, ImVec2(1, 0));
	RenderTextClipped(ImVec2(frame_bb.Min.x, frame_bb.Min.y - 10), ImVec2(frame_bb.Max.x + ImGui::CalcTextSize(value_buf).x + 5, frame_bb.Max.y), value_buf, value_buf_end, NULL, ImVec2(1, 0));


	//RenderText(ImVec2(frame_bb.Min.x + 20, 0), "10");

    if (label_size.x > 0.0f)
		RenderText(ImVec2(window->DC.CursorPos.x, p.y), label);
	//RenderText(ImVec2(frame_bb.Min.x - label_size.x - 10, total_bb.Min.y + style.FramePadding.y + (label_size.y / 2)), label);

...
namespace ImGui
{
    ...
    IMGUI_API bool MenuChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
	...
	IMGUI_API bool BeginChildExSection(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
	IMGUI_API bool MenuChild(const char* str_id, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags);
	IMGUI_API bool BeginChildSection(const char* str_id, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags = 0);
	IMGUI_API bool BeginChild(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API void EndChildSection();
    ...
    IMGUI_API bool TabButtonEx(const char* ico, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool OptButton(const char* ico, const ImVec2& size_arg, bool rotation);
	IMGUI_API bool OptButtonEx(const char* ico, const ImVec2& size_arg, bool rotation, ImGuiButtonFlags flags);
	IMGUI_API bool TabButton(const char* ico, const char* label, const ImVec2& size_arg);

	IMGUI_API bool TabButton(const char* icon, const char* label, float flDpiScale, bool active);

	IMGUI_API bool Keybind(const char* label, int* key, int* mode, bool label_active);

	IMGUI_API void Keybindbox(const char* label, bool* v, int* key, int* m);
    ...
    IMGUI_API bool DiscordSliderInt(const char* label, int* v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags);

...
bool MEM::Setup()
{
	...
	fnUpdateSky = reinterpret_cast<decltype(fnUpdateSky)>(FindPattern(CLIENT_DLL, CS_XOR("48 8B C4 48 89 58 18 48 89 70 20 55 57 41 54 41 55")));
	L_PRINT(LOG_INFO) << "Found UpdateSky at " << (ULONG_PTR)fnUpdateSky;
	bSuccess &= (fnUpdateSky != nullptr);
